...
slug: groovy
imageUrl: 'http://res.cloudinary.com/drnqdd87d/image/upload/v1632514977/Personal/groovy-small_x8y5an.png'
url: 'https://groovyapi.oluwasetemi.dev'
description:
  'The problem I was solving with this solution was an App to manage
  people&apos;s night life including solutions for varying level of user who
  will manage the night-life from inventory each order placed. I worked on the
  backend side of things with Typescript and the newly shinning prisma orm in a
  REST api setup which uses swagger-ui for documentation. The developer
...
The problem I was solving with this solution was an App to manage people&apos;s
night life including solutions for varying level of user who will manage the
night-life from inventory each order placed. I worked on the backend side of
things with Typescript and the newly shinning prisma orm in a REST api setup
which uses swagger-ui for documentation. The developer experience was smooth.
...
- Designed Implemented communication with external API (paystack, flutterwave).
...
very smooth comaored the mongoose modelling of data which I use for some of my
past project.
