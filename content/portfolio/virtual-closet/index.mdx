...
slug: virtual-closet
imageUrl: http://res.cloudinary.com/drnqdd87d/image/upload/v1632400063/Personal/virtual-closet_ywlw1t.png
url: https://virtual-closets.com
description: 'A platform to manage users closet, the backend is built with nodejs and graphql , the data layer is mongoose + mongodb. The frontend is built with Nextjs and it uses Apollo Client for data management, The Backend powers the mobile application built with React Native. The Technology stack is pretty awesome. The platform is managed using the admin interface. The solution was built to solve the problem of wardrobe(closets), it offers the users a digital dasboard to manage closet and help with laundry management.'
technology:
  [
    'nextjs',
    'apollo client',
...
- Designed Implemented communication with external API (stripe and calendar api).
