...
url: ''
description:
  'The team was to implement a solution that allow anyone with a mobile phen and
...
technology: ['vuejs', 'nodejs', 'graphql', 'mongodb']
isPublished: true
publishedDate: '2021-05-05T00:00:00.012Z'
isDraft: false
updated: false
updatedDate: null
---
...
- Collaborate with 2 backend devs, 2 frontend and 2 project managers.
- I convinced the team to use GraphQL.
...
tryig to solve was very intresting to everyone on the team. The designs tool
gave a morale boost. The discussion about the architecture and design of the
system make me so happy. In the end, we ran into a scope creep due to the
