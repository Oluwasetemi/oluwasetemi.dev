...
try to run this with a `jest` in your terminal and you will see the test report
...
Building on the last test I can test the increment button if it work properly.
