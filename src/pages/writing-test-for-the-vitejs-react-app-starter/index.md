...
Just the way the create react app comes with a simple test I wish the vitejs app comes with a default test and setup. Not anything special just a way to be prepared anytime you create a react app with vitejs, more so it creation is brilliant to not include test and test setup. It will be of great advantage to anyone building apps with the starters to have test include. It will be a way to see writing test as part of the journey of the product they are building.

<script src="https://gist.github.com/Oluwasetemi/626fcd9939e12458dd8732292f772440.js"></script>
...
<figcaption>a gist showing test sample of the popular create react app</figcaption><br/>

## my experience and determination to write tests always

I am taking huge delight in writing test for any code I write or software I try to build. From unit to end to end tests. It is very important to see your app from what do I need to make sure functions the way it is designed to or what feature in this app is not permitted to be buggy consciously.

## benefits of writing well tested apps

For instance I have a todo app right and anytime you create a new todo item it add 2 new todo items, there and there you know right that is a bug and must be fixed. Again I have an app that generate lot of money in revenue and anytime this app falls you lose money and resource some way, then it will be your job as the developer to make sure the app is working properly.
