...
like Nextjs, Hasura, GraphQL.I ensure that Eslint, prettier and Stylelint and
TypeScript were all used to lint the codebase. I wrote unit test, integration
tests and end to end tests with cypress and setup CI/CD pipeline to run the test
