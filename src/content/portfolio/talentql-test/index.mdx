...
description:
  ...
  pipeline program for the frontend track. The problem statement is to build a
...
program for the frontend track. The problem statement is to build a grid app
...
- Static testing was done for types, linting and formatting for styles,
  tsx,ts,js files (Typescript, Eslint, Prettier, Stylelint).
...
frontend related projects, the test came in handy. I wanted to become a
generalist developer who can comfortably work on both side of the stack.
Applying for the pipeline program to be mentored was all the push to get this
done. The timeline was 7 days but I have since then added more features
gradually to the App. I have learnt a lot trying to write clean code with this
project. I have written some articles from some of the problems I encountered
