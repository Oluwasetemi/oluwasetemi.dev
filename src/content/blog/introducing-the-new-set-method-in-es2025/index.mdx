---
title: "Introducing the new Set methods in ES2025"
date: "2025-11-08"
...
Reasons to favour this new 😜 modern data structure over the old ones are that:
...
> Keeping up is key to staying relevant in the tech industry. Here is TC39 GitHub to track the stages of the proposals: [TC39 GitHub](https://github.com/tc39/proposals).
...
const beforeSymmetricDifference = new Set(
...
```ts title="subset-and-superset.ts" showLineNumbers=false add={7,11} del={4}
...
```ts title="disjoint-check.ts" showLineNumbers=false add={6,10}
