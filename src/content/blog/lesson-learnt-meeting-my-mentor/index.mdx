...
detailed track of every major place where he had worked, his core
responsibilities and wins. He just knew so well how to sell himself. He
currently builds a team of developers building a product in his present
engagement.
...
2. Developer who will in turn have great career must learn the art of staying
   humble and approach every meeting with an open mind, strong will to always
   listens. Pretend you don't know anything and you will come out of the meeting
   learning a lot. When you speak you will be speaking elaborately on the topic
   of discuss. You would have gathered a lot and could eventually hit a home run
   with a point you might just be contributing. The humble nature of doing the
   due diligence before a team meeting and building confidence from reading
   source code repositories, and specs to get a more clear picture of what your
   team is trying to build. Get the best examples of what you're trying to build
   and study.
...
4. He shared a video titled
   ...
   brain picking out patterns when exposed to **large quantity** and **large
   ...
   more time and try again.". A form of **Perceptual learning**.
...
5. Study a design system from scratch. He believes this will make UI and design
   ...
   into mastery as Front-end Engineer/ Fullstack Engineer a very easy journey.
   He has moved across writing back-end to writing and leading mobile front-end
   teams to writing web front-end and to architecture products. All building
   production quality software that are scalable and fault tolerant across
   several market and technology domain through out the whole world. He noted
   that understanding and studying [12 factor app](https://12factor.net/) will
   give you cross domain expertise.
...
will definitely share more information about him at the very end of my mentoring
with him. Much more the tips and tricks I gleaned is what anyone reading will
benefit from.
